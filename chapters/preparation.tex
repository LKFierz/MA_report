...
\begin{figure}
    \centering
    \includegraphics[scale=0.19]{images/methodology/stereo_limit.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.2, angle=-12]{images/methodology/reference_map2.5m_annotated.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.25]{images/methodology/stereo_2.5m.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.25]{images/methodology/GT_2.5m.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{images/methodology/GT_error_sim.png}
    \caption{Simulation Reference}
    \label{fig:GT_error_sim}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{images/methodology/GT_error_GT.png}
