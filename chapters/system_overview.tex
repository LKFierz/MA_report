...
% When an incoming point cloud comes from a camera pose which yields less than 95\% theoretical image overlap with the previous location, a map shift of the rolling buffer is performed. This shift is implemented as the clearing of the rows and columns no longer necessary and a shift of the starting index for further images. This implementation allows the movement of the map without the need to reassign filled cells. 
%TODO: make schematic image of this or don't put this in the report
