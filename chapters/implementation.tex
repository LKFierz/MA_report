...
Upon leaving the mission state and entering the landing state, the autonomy attempts to select the currently best landing site according to the in \creaf{subsubsec:LandingSiteHeuristic} introduced loss function.
