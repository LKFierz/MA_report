...
% A second application of this switching is to disable the stereo node until the drone reaches approximately 30 cm altitude. The reason for this is that in order to detect the depth of points about 30 cm away from the drone a disparity of about 85 pixels is necessary as shown in \cref{eq:min_depht}:

% \begin{equation}
%     d = \frac{f \cdot b}{z} = \frac{256 * 10cm}{30cm} = 85.333
% \end{equation}

% At 30 cm distance, this overlap is not given. Therefore 
% With an image width of 640 pixels, a baseline of 10 cm and a focal length of 256 pixels we have a FOV of 102.68$\deg$. Therefore, the horizontal distance

% TODO: finish the overlapping FOV calculation
